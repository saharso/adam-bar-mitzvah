...
export function Slide5Birth() {
  return <Youtube videoId={"BC9nSQRG3go"} title={"וידאו מביך 1"} />;
}

export function Slide6Birth() {
  return <Youtube videoId={"Aate5BfY0f0"} title={"וידאו מביך 2"} />;
}
